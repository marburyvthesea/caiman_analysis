...
echo "running motion correction and cnmfe"

python caiman_cnmf_e_full_pipeline_script.py /projects/p30771/miniscope/data/GRIN011/1_24_2019/H10_M19_S59/TIFs/ H10_M19_S59msCam 1 20 

echo "finished motion correction and cnmfe"
